...
/**
 * The explanatory half of the landing page. Shared so the public
 * page and the signed-in /about page cannot drift apart. The
 * section ids are load-bearing: the public nav links at /#measures
 * and /#session point at them.
 */
export default function AboutSections(): ReactElement {
  return (
    <>
